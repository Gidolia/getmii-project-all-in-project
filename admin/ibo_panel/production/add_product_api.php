...
$sho_sel="SELECT * FROM `user` WHERE `u_id`='$_GET[u_id]'";
$sho_que=$con->query($sho_sel);
$sho_fet=$sho_que->fetch_assoc();
?>
<!DOCTYPE html>
<html lang="en">
  <head>
      ...
      <div class="main_container">
						...
						<div class="x_content">
							...
							<form class="form-horizontal form-label-left" method="post" enctype='multipart/form-data'>
								...
								<div class="form-group row">
                                    <label class="col-form-label col-md-3 col-sm-3 ">Select Category</label>
                                    <div class="col-md-9 col-sm-9 ">
                                        
                                      <script> function urlHandler(value) {     window.location.assign(`${value}`);}
                                      </script>
                                   
										<select class="form-control" name="place_id" id="url" onchange="urlHandler(this.value)">
										    <option></option>
							    <?php 
			    $selcsc="SELECT * FROM `city_sub_category` WHERE `c_id`='$sho_fet[csc_id]'";
			    $scop=$con->query($selcsc);
			    while($fetcsc=$scop->fetch_assoc()){?>
                              <option value="add_product_api.php?csc_id=<?php echo $fetcsc[csc_id];?>&u_id=<?php echo $_GET[u_id];?>"  <?php if($_GET[csc_id]==$fetcsc[csc_id]){?>selected<?php }?>><?php echo $fetcsc[name];?></option>
                    <?php }?>
										</select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-md-3 col-sm-3 ">Product Name</label>
                                    <div class="col-md-9 col-sm-9 ">
                                      <input type="text" class="form-control" placeholder="Product Name" name="product_name">
                                    </div>
                                </div>
                                <input type="hidden" name="csc_id" value="<?php echo $_GET[csc_id];?>">
                                <input type="hidden" name="shop_id" value="<?php echo $sho_fet[u_id];?>">
                                <input type="hidden" name="city" value="<?php echo $sho_fet[shop_city];?>">
								...
								<div class="item form-group">
									<label for="middle-name" class="col-form-label col-md-3 col-sm-3 ">Select Color</label>
									<div class="col-md-9 col-sm-9 ">
		...
		if(isset($_GET[csc_id]))
        {
            ...
            <input type="hidden" name="ahs_name[]" value="<?php echo $fet_ar[name];?>">
                                <div class="item form-group">
									<label for="middle-name" class="col-form-label col-md-3 col-sm-3 "><?php echo $fet_ar[name];?></label>
									<div class="col-md-9 col-sm-9 ">
            ...
            <input type="hidden" name="ahs_name[]" value="<?php echo $fet_ar[name];?>">
              ...
              <?php  
				...
				<h4 align="center">images</h4>
				                <div class="item form-group">
									<label for="middle-name" class="col-form-label col-md-3 col-sm-3">Main Img</label>
									<div class="col-md-9 col-sm-9 ">
...
<script type="text/javascript">
		...
		$("#rowAdders").click(function () {
			...
			'<div class="item form-group">'+
									'<label for="middle-name" class="col-form-label col-md-3 col-sm-3">Images</label>'+
									'<div class="col-md-9 col-sm-9 ">'+
		...
		$("body").on("click", "#DeleteRow", function () {
			$(this).parents("#row").remove();
	                            ...
	                            <div class="item form-group">
									<label for="middle-name" class="col-form-label col-md-3 col-sm-3">MRP</label>
									<div class="col-md-9 col-sm-9 ">
										<input type="number" class="form-control" name="mrp">
									</div>
								</div>
								<div class="item form-group">
									<label for="middle-name" class="col-form-label col-md-3 col-sm-3">Selling Price</label>
									<div class="col-md-9 col-sm-9 ">
										<input type="text" class="form-control" name="sp">
									</div>
								</div>
								<div class="item form-group">
									<label for="middle-name" class="col-form-label col-md-3 col-sm-3">Stock Quantity</label>
									<div class="col-md-9 col-sm-9 ">
										<input type="text" class="form-control" name="qty">
									</div>
								</div>
								<div class="item form-group">
									<label for="middle-name" class="col-form-label col-md-3 col-sm-3">Brand Name</label>
									<div class="col-md-9 col-sm-9 ">
										<input type="text" class="form-control" name="brand_name">
									</div>
								</div>
								<div class="item form-group">
									<label for="middle-name" class="col-form-label col-md-3 col-sm-3">Short Description</label>
									<div class="col-md-9 col-sm-9 ">
										<input type="text" class="form-control" name="s_description">
									</div>
								</div>
								<div class="item form-group">
									<label for="middle-name" class="col-form-label col-md-3 col-sm-3">Long Description</label>
									<div class="col-md-9 col-sm-9 ">
								...
								<div class="item form-group">
									<label for="middle-name" class="col-form-label col-md-3 col-sm-3">Delivery Time</label>
									<div class="col-md-9 col-sm-9 ">
...
if(isset($_POST[sub_banp])){
    ...
    $selcscsss="SELECT * FROM `user` WHERE `u_id`='$_POST[shop_id]'";
    ...
    if(move_uploaded_file($_FILES["img"]["tmp_name"], "../../../images/".$p_id.$d_id.".jpg"))
	{
        ...
        if($con->query($fr)===TRUE){
            ...
            echo "<script>location.href='add_product_api.php?n=p_s';</script>";
        }else{
            ...
            $con->query($pla);
            echo "<script>location.href='add_product_api.php?n=p_f';</script>";
        }
	}
}
