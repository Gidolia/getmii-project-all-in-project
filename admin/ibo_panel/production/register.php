...
<html lang="en">
  <head>
    ...
    <title>Add Delievery Man || GETMII</title>
...
<!--Page Content-->
        ...
        <div class="col-md-12 col-sm-12 ">
          <div class="x_panel">
            <div class="x_title">
              <h2>Insert Delievery Man<small></small></h2>
...
if(isset($_POST[submit_reg]))
{
    ...
    $sel="INSERT INTO `delievery_man` (`id`, `name`, `password`, `photo`, `adhar_card_no`, `mobile_no`, `status`, `city`, `d_lisence_no`) VALUES (NULL, '$_POST[name]', '$_POST[pwd]', '$filename1', '$_POST[adhar]', '$_POST[mob]', '1', '$_POST[city]', '$_POST[d_l]');";
