      ...
      <div class="">
        ...
        <div class="row">
			<div class="col-md-12 col-sm-12 ">
				<div class="x_panel">
					<div class="x_title">
						<h2>Insert New Sub Category<small></small></h2>
                            ...
                            <div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 ">
									...
									<select name="c_id" class="form-control">
									    ...
									    ?>
									    <option value="<?php echo $der[id];?>" <?php if($_GET[c]==
$der[id] && isset($_GET[c])){?>selected<?php }?>>
									        <?php echo $der[name];?>
									    </option>
									    <?php }?>
									</select>
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 ">
									<input type="text" name="su_name" required="required" class="form-control">
								</div>
							</div>
							<div class="item form-group">
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 ">
									<input type="text" name="shipping" required="required" class="form-control">
								</div>
							</div>
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 ">
									<input type="radio" class="flat" name="color_r" value="1" checked="" required />Yes<br>
                                    <input type="radio" class="flat" name="color_r" value="0" />No
								</div>
							</div>
...
?>
        ...
        <form method="post" class="form-horizontal form-label-left">
                <div class="form-group">
                    ...
                    <option value="create_sub_category.php" <?php if(empty($_GET[c])){?>selected<?php }?>>Select Screen</option>
                    <?php 
                    ...
                    <option value="create_sub_category.php?c=<?php echo $R[id];?>" <?php if($_GET[c]==
$R[id] && isset($_GET[c])){?>selected<?php }?>><?php echo $R[name];?></option>
                <?php }?>
                </select>
                      </span>
                    </div>
                 ...
                 <table id="datatable-buttons" class="table table-striped jambo_table" >
                  ...
                  <tbody>
                      <?php
                            $au=1;
                            if(isset($_GET[c])){
                                $e="SELECT * FROM `city_sub_category` WHERE `c_id`='$_GET[c]'";
                            }
                             else{
                            $e="SELECT * FROM `city_sub_category`";
                             }
                            $d=$con->query($e);
                            while($R=$d->fetch_assoc()){
                            ?>
                           <tr>
                            ...
                            <td><a href="edit_city_sub_category.php?id=<?php echo $R[csc_id];?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Edit Information </a></td>
