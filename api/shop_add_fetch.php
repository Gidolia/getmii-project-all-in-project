...
if($_GET[shop_id]>0)
{
$de="SELECT * FROM `shop_add` WHERE `shop_id`='$_GET[shop_id]'";
$dc=$con->query($de);
if($dc->num_rows==0){
  $data[]=array("message"=>"0");
}
