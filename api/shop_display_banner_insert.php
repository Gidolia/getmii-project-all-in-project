...
if($_POST[a]==1)
{
    ...
    {   $img1=$u_id.$d_id."1.jpg";
        $re="INSERT INTO `shop_poster` (`sp_id`, `shop_id`, `img_no`, `img`, `img2`, `img3`, `img4`, `c_date`, `c_time`, `color`, `name1`, `name2`, `name3`, `name4`) VALUES (NULL, '$_POST[u_id]', '1', '$img1', '', '', '', '$date', '$time', '$_POST[color]', '$_POST[name1]', '$_POST[name2]', '$_POST[name3]' , '$_POST[name4]');";
        $con->query($re);
...
elseif($_POST[a]==2)
{
    ...
    {   $img1=$u_id.$d_id."1.jpg";
        ...
        $re="INSERT INTO `shop_poster` (`sp_id`, `shop_id`, `img_no`, `img`, `img2`, `img3`, `img4`, `c_date`, `c_time`, `color`, `name1`, `name2`, `name3`, `name4`) VALUES (NULL, '$_POST[u_id]', '2', '$img1', '$img2', '', '', '$date', '$time', '$_POST[color]', '$_POST[name1]', '$_POST[name2]', '$_POST[name3]' , '$_POST[name4]');";
        $con->query($re);
        $data[]=array("message"=>"1");
...
elseif($_POST[a]==4)
{
    ...
    {   $img1=$u_id.$d_id."1.jpg";
        ...
        $re="INSERT INTO `shop_poster` (`sp_id`, `shop_id`, `img_no`, `img`, `img2`, `img3`, `img4`, `c_date`, `c_time`, `color`, `name1`, `name2`, `name3`, `name4`) VALUES (NULL, '$_POST[u_id]', '4', '$img1', '$img2', '$img3', '$img4', '$date', '$time','$_POST[color]', '$_POST[name1]', '$_POST[name2]', '$_POST[name3]' , '$_POST[name4]');";
        $con->query($re);
        $data[]=array("message"=>"1");
    }else{$data[]=array("message"=>"0");}
}else{$data[]=array("message"=>"0");}
