...
{
$de="SELECT * FROM `shop_add` WHERE `shop_id`='$_POST[shop_id]' AND  `img_no`='$_POST[img_no]'  ";
$dc=$con->query($de);
if($dc->num_rows==0){
  $data[]=array("message"=>"0");
}
