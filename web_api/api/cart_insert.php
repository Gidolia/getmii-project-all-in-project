<?php
    ...
    $sel="SELECT * FROM `cart` WHERE `u_id`='$_POST[u_id]' AND `p_id`='$_POST[p_id]'";
    $cpo=$con->query($sel);
    ...
    if($count>0){
        ...
        $de="INSERT INTO `cart` (`cart_id`, `u_id`, `p_id`, `qty`, `add_date`, `add_time`, `cs_id`) VALUES (NULL, '$_POST[u_id]', '$_POST[p_id]', '1', '$date', '$time', '$_POST[cs_id]');";
