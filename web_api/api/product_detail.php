<?php
 include "../config.php";
 $de="SELECT * FROM `product` WHERE `p_id`='$_POST[p_id]' AND `status`='1'";
$dc=$con->query($de);
if($dc->num_rows==0){
