...
{   $img1=$d_id."1.jpg";
    ...
    $s="INSERT INTO `second_hand_product` (`shp_id`, `shc_id`, `u_id`, `name`, `old`, `product_description`, `amount`, `main_img`, `img2`, `img3`, `status`, `city`, `date`, `time`) VALUES (NULL, '$_POST[shc_id]', '$_POST[u_id]', '$_POST[name]', '$_POST[old]', '$_POST[p_description]', '$_POST[amount]', '$img1', '$img2', '$img3', 'r', '$_POST[city]', '$date', '$time');";
    if($con->query($s)===TRUE){
